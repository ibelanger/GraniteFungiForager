...
export const speciesData = {
    ...
    beefsteak: {
        ...
        tempRange: [60, 80],
        moistureMin: 1.5,
        seasonMultiplier: { spring: 0.2, summer: 0.7, fall: 1.0, winter: 0.05 },
    ...
    blacktrumpets: {
        ...
        tempRange: [55, 75],
        moistureMin: 2.0,
        seasonMultiplier: { spring: 0.1, summer: 0.7, fall: 1.0, winter: 0.05 },
    ...
    cauliflower: {
        ...
        tempRange: [55, 75],
        moistureMin: 1.5,
        seasonMultiplier: { spring: 0.1, summer: 0.6, fall: 1.0, winter: 0.05 },
    ...
    chanterelles: {
        ...
        tempRange: [55, 75],
        moistureMin: 2.0,
        seasonMultiplier: { spring: 0.1, summer: 1.0, fall: 0.7, winter: 0.05 },
    ...
    trumpetchanterelle: {
        ...
        tempRange: [50, 70],
        moistureMin: 2.0,
        seasonMultiplier: { spring: 0.1, summer: 0.2, fall: 1.0, winter: 0.05 },
    ...
    greenrussula: {
        ...
        tempRange: [55, 75],
        moistureMin: 1.5,
        seasonMultiplier: { spring: 0.1, summer: 1.0, fall: 0.5, winter: 0.05 },
    ...
    sweettooth: {
        ...
        tempRange: [55, 75],
        moistureMin: 1.5,
        seasonMultiplier: { spring: 0.1, summer: 0.7, fall: 1.0, winter: 0.1 },
    ...
    jellyear: {
        ...
        tempRange: [45, 70],
        moistureMin: 1.5,
        seasonMultiplier: { spring: 0.9, summer: 0.5, fall: 1.0, winter: 0.45 },
    ...
    boletusSubcaerulescens: {
        ...
        tempRange: [50, 70],
        moistureMin: 2.0,
        seasonMultiplier: { spring: 0.1, summer: 0.4, fall: 1.0, winter: 0.05 },
        ...
        fruitingStyle: 'scattered',
        regions: {
            'Great North Woods': 0.75, // Excellent conifer habitat
    ...
    boletusVariipes: {
        ...
        tempRange: [60, 75],
        moistureMin: 2.0,
        seasonMultiplier: { spring: 0.1, summer: 1.0, fall: 0.8, winter: 0.05 },
        ...
        regions: {
            ...
            'Merrimack Valley': 0.7,
            'Lakes Region': 0.6,
            'Monadnock Region': 0.75,   // Excellent oak-beech forests
            'Seacoast': 0.6
        }
    },
    boletusEdulis: {
        ...
        tempRange: [55, 75],
        moistureMin: 2.0,
        seasonMultiplier: { spring: 0.2, summer: 0.8, fall: 1.0, winter: 0.05 },
    ...
    boletus_separans: {
        ...
        tempRange: [55, 75],
        moistureMin: 1.8,
        seasonMultiplier: { spring: 0.2, summer: 0.9, fall: 1.0, winter: 0.05 },
    ...
    boletusNobilis: {
        ...
        regions: {
            'Great North Woods': 0.5,
            'White Mountains': 0.6,
            'Dartmouth-Sunapee': 0.62,
            'Merrimack Valley': 0.6,
            'Lakes Region': 0.5,
            'Monadnock Region': 0.62,
            'Seacoast': 0.4
        }
    },
    boletusChippewaensis: {
        ...
        regions: {
            ...
            'White Mountains': 0.75,  // Excellent hemlock habitat
            'Dartmouth-Sunapee': 0.6,
            'Merrimack Valley': 0.4,
            'Lakes Region': 0.6,
            'Monadnock Region': 0.5,
    ...
    hericium: {
        ...
        tempRange: [50, 70],
        moistureMin: 1.5,
        seasonMultiplier: { spring: 0.2, summer: 0.3, fall: 1.0, winter: 0.1 },
        ...
        regions: {
            'Great North Woods': 0.65,
            'White Mountains': 0.60,
            'Dartmouth-Sunapee': 0.60,
            'Merrimack Valley': 0.60,
            'Lakes Region': 0.60,
    ...
    maitake: {
        ...
        tempRange: [55, 75],
        moistureMin: 2.0,
        seasonMultiplier: { spring: 0.2, summer: 0.4, fall: 1.0, winter: 0.05 },
    ...
    blewit: {
        ...
        tempRange: [45, 65],
        moistureMin: 1.5,
        seasonMultiplier: { spring: 0.2, summer: 0.4, fall: 1.0, winter: 0.15 },
    ...
    winecap: {
        ...
        tempRange: [55, 80],
        moistureMin: 1.5,
        seasonMultiplier: { spring: 0.9, summer: 0.3, fall: 0.9, winter: 0.1 },
    ...
    shaggymane: {
        ...
        tempRange: [50, 75],
        moistureMin: 1.0,
        seasonMultiplier: { spring: 0.7, summer: 0.4, fall: 1.0, winter: 0.2 },
        ...
        regions: {
            'Great North Woods': 0.3,
            'White Mountains': 0.35,
            'Dartmouth-Sunapee': 0.45,
            'Merrimack Valley': 0.55,
            'Lakes Region': 0.45,
            'Monadnock Region': 0.5,
            'Seacoast': 0.55
    ...
    corrugatedmilky: {
        ...
        tempRange: [60, 80],
        moistureMin: 1.5,
        seasonMultiplier: { spring: 0.1, summer: 1.0, fall: 0.6, winter: 0.1 },
    ...
    orangemilky: {
        ...
        tempRange: [60, 80],
        moistureMin: 1.5,
        seasonMultiplier: { spring: 0.2, summer: 0.9, fall: 1.0, winter: 0.1 },
